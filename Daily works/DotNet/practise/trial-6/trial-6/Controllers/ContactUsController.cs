...
namespace trial_6.Controllers
{
    public class ContactUsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ContactId,Name,Email,PhoneNumber,QueryMessage")] ContactU contactU)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContactId,Name,Email,PhoneNumber,QueryMessage")] ContactU contactU)
        {
